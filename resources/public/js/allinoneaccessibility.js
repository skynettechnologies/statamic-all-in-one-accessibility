(function () {
    ...
    function init() {
        ...
        if (!form) {
            console.warn("Form not found (Statamic Vue not ready yet)...");
            return;
        }
    ...
    /* ---------------- IMPORTANT (STATAMIC FIX) ---------------- */
    // Statamic CP loads via Vue → DOMContentLoaded is NOT reliable
    // So we retry until form exists
